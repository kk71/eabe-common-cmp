...
"""
        ...
        for v, smv in self.sm.get_all_status_dict().items():
    ...
    def list_resp(self, export_flag: str | None = None) -> list[dict]:
        ...
        for sm in self.sms.values():
            ...
            r.append({
                ...
                "smvs": [smv.to_dict(exclude_extra=self.exclude_extra) for smv in sm.get_all_status_dict().values()],
