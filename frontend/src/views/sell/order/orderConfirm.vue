    ...
    <modal title="新增确认" btnType="1" :showModal="showEditModal" @cancel="showEditModal = false" @submit="submitAddress">
      <template #body>
        <div class="edit-wrap">
          ...
          <div class="item">
            <textarea name="street" v-model="checkedItem.street"></textarea>
          </div>
          <div class="item">
            <input type="text" class="input" placeholder="邮编" v-model="checkedItem.postalCode" />
          </div>
        </div>
      </template>
    </modal>
