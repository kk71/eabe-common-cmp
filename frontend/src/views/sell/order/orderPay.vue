    ...
    <div class="wrapper">
      <div class="container">
          ...
          <div class="item-detail" v-if="showDetail">
            ...
            <div class="item good">
              ...
              <div class="detail-info">
                <ul>
                  <li v-for="(item, index) in orderDetail" :key="index"> <img :src="item.productMainImage" />{{ item.productName }} </li>
                </ul>
              </div>
            </div>
            <div class="item">
        ...
        <div class="item-pay">
          ...
          <div class="pay-way">
            <p>支付平台</p>
            <div class="pay pay-ali" :class="{ checked: payTool == 1 }" @click="paySubmit(1)"></div>
            <div class="pay pay-wechat" :class="{ checked: payTool == 2 }" @click="paySubmit(2)"></div>
          </div>
        </div>
      </div>
    </div>
