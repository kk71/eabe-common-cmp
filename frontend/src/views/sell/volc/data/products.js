    ...
    items: [
      {
        ...
        detail: {
          ...
          intro: '火山引擎GPU云服务器搭载NVIDIA最新一代A100/H100 GPU，提供强劲的并行计算能力。适用于深度学习训练与推理、高性能计算(HPC)、图形图像渲染、视频转码等GPU密集型场景。结合弹性扩缩、高速RDMA互联网络，助力企业高效完成AI模型训练与推理任务。',
          highlights: [
      ...
      },
      {
        ...
        detail: {
          banner: '安全稳定的弹性云服务器',
          intro: '火山引擎云服务器ECS提供安全可靠、弹性可伸缩的计算服务，支持通用型、计算型、内存型、高主频型等多种实例规格。内置云监控与安全防护，配合镜像、快照、弹性IP等能力，助力企业快速构建并灵活管理云上业务。',
          highlights: [
    ...
    items: [
      ...
      },
      {
        ...
        detail: {
          ...
          intro: '火山引擎CDN拥有全球2800+加速节点，总储备带宽超150Tbps。通过智能调度系统将用户请求导向最近的边缘节点，实现毫秒级响应。支持全站加速、HTTPS、WebSocket、HTTP/3等特性，助力网站和应用提供极致用户体验。',
          highlights: [
      ...
      },
      {
        ...
        detail: {
          ...
          intro: '私有网络VPC让您在火山引擎上构建逻辑隔离的虚拟网络环境。可自定义IP地址段、子网划分、路由策略和安全组规则。VPC间完全隔离，配合NAT网关、VPN网关、对等连接等组件，灵活构建混合云和多VPC网络架构。',
          highlights: [
    ...
    items: [
      {
        ...
        detail: {
          ...
          specs: [
            ...
            { label: '对接', value: '火山方舟 / PyTorch / HuggingFace' },
    ...
    items: [
      {
        ...
        detail: {
          banner: '一站式音视频点播服务',
          intro: '视频点播提供从上传、存储、转码、审核到分发播放的全链路音视频服务。内置智能转码引擎、AI内容审核、多码率自适应等能力。基于火山引擎全球CDN加速，提供流畅的点播观看体验，服务覆盖全球200+国家和地区。',
          highlights: [
      ...
      },
      {
        ...
        detail: {
          banner: '全球低延时实时音视频通信',
          intro: '实时音视频RTC提供全球低延时(< 200ms)的实时音视频通信服务。基于火山引擎全球分布式传输网络，支持1v1通话、多人会议、互动直播等场景。集成AI降噪、美颜滤镜、虚拟背景等端侧AI能力，提供高品质通信体验。',
          highlights: [
